		...
		<div class="col-xs-12">
			<?php if(is_array($address)): foreach($address as $key=>$x): ?><div class="col-xs-3">
					<?php if($x["active"] == 1): ?><div  class='col-xs-12 get-adress adress'>
						...
						<a href="" style="float: left" class="sing-active" attr-id="<?php echo ($x["address_id"]); ?>">设置为默认地址</a>
						<a href="" style="float: right" class="sing-delete" attr-id="<?php echo ($x["address_id"]); ?>">
			...
			<tbody class="text-center">
				<?php if(is_array($order)): foreach($order as $key=>$v): ?><tr>
						<td style="vertical-align: middle !important;" class="text-left">
							<img src="<?php echo ($v["img"]); ?>" height="70"><?php echo ($v["name"]); ?></div>
					</td>
					<td style="vertical-align: middle !important;"><?php echo ($v["product_num"]); ?></td>
					<td style="vertical-align: middle !important;">￥<?php echo ($v["price"]); ?></td>
					<td style="vertical-align: middle !important;">￥<?php echo ($v['price']*$v["product_num"]); ?></td>
...
<div class="col-xs-12">
	...
	<div class="col-xs-3">
		<div class="col-xs-12">
			...
			<div class="col-xs-6" style="padding:10px 0px">￥<?php echo ($total); ?></div>
		</div>
		...
		<div class="col-xs-12" style="margin-top: 20px;">
			...
			<div class="col-xs-6">
				<h3 style="color: #c9302c">￥<?php echo ($total); ?></h3>
			</div>
	...
	<div class="jumbotron">
	  <h1>暂无任何商品</h1>
	  <p style="margin-top:40px"><a class="btn btn-primary btn-danger" href="<?php echo U('index/index');?>" role="button">去购物</a></p>
	</div><?php endif; ?>
	<?php if($outProduct): ?><div class="col-xs-12">
		...
		<div class="col-xs-12">
			<table class="table " style="border-bottom: 2px ridge #DDDDDD">
				...
				<tbody class="text-center">
					<?php if(is_array($outProduct)): foreach($outProduct as $key=>$x): ?><tr>
							<td style="vertical-align: middle !important;" class="text-left">
								<img src="<?php echo ($x["img"]); ?>" height="70"><?php echo ($x["name"]); ?></div>
						</td>
						<td style="vertical-align: middle !important;"><?php echo ($x["product_num"]); ?></td>
						<td style="vertical-align: middle !important;color:red"><?php echo ($x["count"]); ?></td>
						<td style="vertical-align: middle !important;">￥<?php echo ($x["price"]); ?></td>
						<td style="vertical-align: middle !important;">￥<?php echo ($x['price']*$x["product_num"]); ?></td>
					</tr><?php endforeach; endif; ?>
			</tbody>
		</table>
	</div>
