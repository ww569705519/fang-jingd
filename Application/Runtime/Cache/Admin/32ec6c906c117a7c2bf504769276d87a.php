                        ...
                        <form enctype="multipart/form-data"  method="post">
                            <div class="uinArea" id="uinArea">
                                ...
                                <div class="inputOuter" id="uArea">
                                    ...
                                    <input type="text" id="u" name="username" placeholder="请填写用户名" class="inputstyle"/>
                                </div>
                            </div>
                            <div class="pwdArea" id="pwdArea">
                                ...
                                <div class="inputOuter" id="pArea">
                                    ...
                                    <input type="password" placeholder="密码" required name="password" class="inputstyle"/>
                                </div>
                            </div>

                            <div style="padding-left:50px;margin-top:20px;">
                                <input type="button" value="登 录" style="width:150px;" class="button_blue" onclick="login.check()"/>
                            </div>
                        </form>
                    </div>
